 ...
 * generated in the sumws.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _CalculateSum_QNAME = new QName("http://ws.sumws/", "calculateSum");
    private final static QName _CalculateSumResponse_QNAME = new QName("http://ws.sumws/", "calculateSumResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: sumws.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.sumws/", name = "calculateSum")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.sumws/", name = "calculateSumResponse")
